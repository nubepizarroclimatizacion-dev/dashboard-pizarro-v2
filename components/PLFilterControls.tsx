...
interface PLFilterControlsProps {
  years: string[];
...
const PLFilterControls: React.FC<PLFilterControlsProps> = ({
  years, months, filters, onFilterChange, onResetFilters,
}) => {
...
export default React.memo(PLFilterControls);